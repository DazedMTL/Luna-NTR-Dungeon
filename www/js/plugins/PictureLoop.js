 ...
 * @default 100
 *
 * @param BattleErasePicture
 * @desc バトル突入時自動消去するまばたきの差分ピクチャID(無効は0)
 * @default 0
 *
 * @param BattleEndCommon
 * @desc バトル終了時再開するコモンイベントID
 * @default 0
 *
 * @help
 *
...
var BattleErasePicture = Number(parameters["BattleErasePicture"] || 0);
var BattleEndCommon = Number(parameters["BattleEndCommon"] || 0);
...
//バトル中のまばたき禁止
var RiruPictureloop_battleinitialize = Scene_Battle.prototype.initialize;
Scene_Battle.prototype.initialize = function () {
  RiruPictureloop_battleinitialize.call(this);
  EraseLoopPicture(BattleErasePicture); //riru追加
};
//バトル終了後のコモン再開処理
var RiruPictureloop_battleterminate = Scene_Battle.prototype.terminate;
Scene_Battle.prototype.terminate = function () {
  RiruPictureloop_battleterminate.call(this);
  $gameTemp.reserveCommonEvent(BattleEndCommon); //riru追加
};
