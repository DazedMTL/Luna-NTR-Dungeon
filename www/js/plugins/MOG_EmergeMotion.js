...
Scene_Battle.prototype.needSkipBattleProcessEM = function () {
  if ($gameTemp._emerging[0]) {
    return true;
  }
  if ($gameTemp._emerging[1] > 0) {
    return true;
  }
  return false;
};
...
//==============================
var _mog_eMot_sBat_updateBattleProcess =
...
Sprite_Enemy.prototype.setIndexEm = function (index) {
  ...
  this._battler._emerge[3] =
    Number(Moghunter.emot_initialWait) +
    this._indexEM * Number(Moghunter.emot_next);
};
...
Sprite_Enemy.prototype.setupEMot = function () {
  ...
  this._battler._emerge[3] = Imported.MOG_BattleTransitions
    ? 2 + Math.randomInt(20)
    : 30 + Math.randomInt(20); // Initial Wait
  this._battler._emerge[5] = false; //Data Check
  this._battler._emerge[7] = 1; // Scale X
  this._battler._emerge[8] = 1; // Scale Y
  this._battler._emerge[9] = 1.0 / this._battler._emerge[6]; // Speed
...
Sprite_Enemy.prototype.setBattlerMotionEm = function () {
  this._battler._emerge[1] =
    this._battler.screenX() + this._offsetX + this._battler.motion_Xaxis();
  this._battler._emerge[2] =
    this._battler.screenY() + this._offsetY + this._battler.motion_Yaxis();
};
...
Sprite_Enemy.prototype.setupEmotType = function () {
  ...
  if (this._battler._emerge[4] != 6) {
    this._battler._emerge[9] = 1.0 / this._battler._emerge[6];
  }
...
Sprite_Enemy.prototype.updateBouncingEmot = function () {
  ...
  if (this._battler._emerge[14] === 0) {
    ...
    if (this._battler._emerge[15] === 0) {
      if (this.scale.x < this._battler._emerge[7] + 0.3) {
        this.scale.x += 0.03;
        this.scale.y -= 0.03;
        if (this.scale.x >= this._battler._emerge[7] + 0.3) {
          this.scale.x = this._battler._emerge[7] + 0.3;
          this.scale.y = this._battler._emerge[7] - 0.3;
...
Sprite_Enemy.prototype.updateSwingEm = function () {
  if (this._battler._emerge[15] === 0) {
    ...
    if (this._battler._emerge[14] < 6) {
      return;
    }
    this._battler._emerge[14] = 0;
    this.scale.x =
      this.scale.x > 0 ? -this._battler._emerge[7] : this._battler._emerge[7];
...
Sprite_Enemy.prototype.updateEmMotion = function () {
  ...
  if (this._battler._emerge[3] > 0) {
    this._battler._emerge[3]--;
    if (
      this._battler._emerge[3] === 0 &&
      this._battler._emerge[4] === 10 &&
      this._battler._emerge[13]
    ) {
  ...
  if (this._battler._emerge[4] === 10) {
    this.updateAnimationEmot();
  }
  if (this._battler._emerge[4] === 6) {
    this.updateFrameEm();
  }
...
Sprite_Enemy.prototype.isEmotEmerging = function () {
  if (this.x != this._battler._emerge[1]) {
    return true;
  }
  if (this.y != this._battler._emerge[2]) {
    return true;
...
Sprite_Enemy.prototype.needUpdateEm = function () {
  ...
  if (Imported.MOG_Theatrhythm && $gameSystem._theatrhythm) {
    return false;
  }
  return true;
};
