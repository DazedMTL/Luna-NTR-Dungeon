...
(function () {
  ...
  var settings = {
    ...
    timeZone: [
      ...
      { name: "深夜", start: 0, end: 3, timeId: 5 },
      { name: "早朝", start: 4, end: 6, timeId: 1 },
      { name: "朝", start: 7, end: 9, timeId: 2 },
      { name: "昼", start: 10, end: 13, timeId: 3 },
      { name: "昼下がり", start: 14, end: 15, timeId: 2 },
      { name: "夕方", start: 16, end: 18, timeId: 4 },
      { name: "夜", start: 19, end: 24, timeId: 5 },
    ],
    /* timeTone:時間帯ごとの色調 */
    timeTone: [
