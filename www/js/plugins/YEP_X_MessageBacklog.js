...
if (Imported.YEP_MessageCore) {
  ...
  Yanfly.Param.MsgBacklogDefaultLog = String(
    Yanfly.Parameters["DefaultLogging"]
  );
  Yanfly.Param.MsgBacklogDefaultLog = eval(Yanfly.Param.MsgBacklogDefaultLog);
  Yanfly.Param.MsgBacklogSpcInput = String(
    Yanfly.Parameters["LogSpecialInput"]
  );
  ...
  Yanfly.Param.MsgBacklogMaxEntries = Number(
    Yanfly.Parameters["MaximumEntries"]
  );
  Yanfly.Param.MsgBacklogScrBarEn = String(
    Yanfly.Parameters["ScrollBarEnabled"]
  );
  Yanfly.Param.MsgBacklogScrBarEn = eval(Yanfly.Param.MsgBacklogScrBarEn);
  Yanfly.Param.MsgBacklogScrBarCol = Number(
    Yanfly.Parameters["ScrollBarColor"]
  );
  Yanfly.Param.MsgBacklogScrBarSpriteCode = JSON.parse(
    Yanfly.Parameters["ScrollBarSpriteCode"]
  );
  ...
  Yanfly.Param.MsgBacklogPicOpacity = Number(
    Yanfly.Parameters["PictureOpacity"]
  );
  Yanfly.Param.MsgBacklogPicStretch = String(
    Yanfly.Parameters["PictureStretch"]
  );
