...
(function () {
  ...
  const pAutoOverpassHigher = toBoolean(
    parameters["AutoOverpassHigher"],
    false
  );
  ...
  const _Game_CharacterBase_isCollidedWithEvents =
  ...
  Game_CharacterBase.prototype.isCollidedWithSameHigherEvents = function (
    x,
    y
  ) {
  ...
  const _Game_CharacterBase_refreshBushDepth =
   ...
   * Game_Character
   */
  const _Game_Character_findDirectionTo =
  ...
  Game_Event.prototype.isCollidedWithEvents = function (x, y) {
    return (
      _Game_Event_isCollidedWithEvents.apply(this, arguments) &&
      this.isCollidedWithSameHigherEvents(x, y)
    );
  };
  ...
  if (typeof Game_PrefabEvent !== "undefined") {
    const _Game_PrefabEvent_locateWithoutStraighten =
      Game_PrefabEvent.prototype.locateWithoutStraighten;
   ...
   * Game_Map
   */
  Game_Map.prototype.isRegionOrTerrainTag = function (
    x,
    y,
    regionId,
    terrainTag
  ...
  Game_Map.prototype.isOverPath = function (x, y) {
    return this.isRegionOrTerrainTag(
      x,
      y,
      pOverPathRegion,
      pOverPathTerrainTag
  ...
  Game_Vehicle.prototype.isLandOk = function (x, y, d) {
    ...
    if (
      this.isOnOverPath() &&
      !this._higher &&
      !$gameMap.isPassableLowerLayer(x, y, d)
    ) {
      return false;
    }
